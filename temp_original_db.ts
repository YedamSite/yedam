...
const DEFAULT_STATE: DbState = {
  ...
  categories: [
    ...
    { id: '20eebc99-9c0b-4ef8-bb6d-6bb9bd380a22', name: 'Cuidado Corporal', slug: 'cuidado-corporal', description: 'Hidrata+�+�o e tratamento para todo o corpo.', image: 'https://images.unsplash.com/photo-1612817288484-6f916006741a?q=80&w=400' },
    { id: '30eebc99-9c0b-4ef8-bb6d-6bb9bd380a33', name: 'Cuidado Capilar', slug: 'cuidado-capilar', description: 'Shampoos, condicionadores e m+�scaras capilares.', image: 'https://images.unsplash.com/photo-1535585209827-a15fcdbc4c2d?q=80&w=400' },
  ...
  brands: [
    { id: 'c0eebc99-9c0b-4ef8-bb6d-6bb9bd380a33', name: 'Round Lab', slug: 'round-lab', description: 'Produtos formulados com +�gua do fundo do mar e ingredientes naturais.', is_featured: true },
    ...
    { id: '70eebc99-9c0b-4ef8-bb6d-6bb9bd380a77', name: 'Skin1004', slug: 'skin1004', description: 'Produtos baseados em extrato puro de Centella Asi+�tica de Madagascar.', is_featured: true }
  ],
  products: [
  ...
  orders: [
    ...
    },
    {
      ...
      shipping_address: { first_name: 'Maria', last_name: 'Rodriguez', street: 'Avenida Paulista', number: '1000', city: 'S+�o Paulo', state: 'SP', country: 'Brasil' },
      billing_address: { first_name: 'Maria', last_name: 'Rodriguez', street: 'Avenida Paulista', number: '1000', city: 'S+�o Paulo', state: 'SP', country: 'Brasil' },
    ...
    },
    {
      ...
      shipping_address: { first_name: 'Carlos', last_name: 'Mendoza', street: 'Carrera 7', number: '45-20', city: 'Bogot+�', state: 'Cundinamarca', country: 'Colombia' },
      billing_address: { first_name: 'Carlos', last_name: 'Mendoza', street: 'Carrera 7', number: '45-20', city: 'Bogot+�', state: 'Cundinamarca', country: 'Colombia' },
    ...
    },
    {
      ...
      content: {
        items: [
          ...
          { icon: 'Truck', title: 'ENV+�OS INTERNACIONALES', text: 'A toda Am+�rica Latina' },
          { icon: 'ShieldAlert', title: 'PAGOS SEGUROS', text: 'Protegemos tu compra' },
          { icon: 'Heart', title: 'ATENCI+�N PREMIUM', text: 'Estamos para ayudarte' }
        ]
      },
      sort_order: 1,
      active: true
  ...
  site_content: {
    home: {
      hero: {
        ...
        subtitle: 'Cosm+�ticos coreanos aut+�nticos seleccionados para cada etapa de tu cuidado facial. F+�rmulas bot+�nicas que revelan tu luminosidad natural.',
        btnBuyText: 'COMPRAR AHORA',
        btnBuyLink: '/tienda',
        btnRoutineText: 'DESCUBRIR RUTINAS',
        btnRoutineLink: '/rutinas',
      ...
      highlights: {
        items: [
          ...
          { icon: 'Heart', title: 'ATENCI+�N PERSONALIZADA', text: 'Estamos para ayudarte' }
        ]
      },
      categories: {
        ...
        buttonText: 'VER TODAS LAS CATEGOR+�AS'
      },
      bestSellers: {
      ...
      experiencias: {
        ...
        title: 'Vive la belleza coreana m+�s all+� de los productos',
        cards: [
          {
          ...
          {
            badge: 'EN COLABORACI+�N CON MAEUM',
            badgeColor: 'blue',
          ...
          },
          {
            ...
            badgeColor: 'accent',
            title: 'M+�s que belleza, una conexi+�n.',
      ...
      instagram: {
        ...
        subtitle: 'Tips, rutinas, lanzamientos y mucho m+�s en Instagram.',
      ...
      newsletter: {
        ...
        successMessage: 'ԣ� -�Te has suscrito con +�xito! Bienvenido al Cheotnun Club.'
      }
    },
    header: {
    ...
    footer: {
      description: 'Importamos los cosm+�ticos coreanos m+�s exclusivos y galardonados a nivel internacional para transformar tu rutina diaria de skincare en un ritual de lujo.',
      social: {
      ...
      marcas: {
        testimonials: {
          ...
          buttonText: 'VER M+�S OPINIONES',
          buttonLink: 'https://www.instagram.com/lacheotnun/',
          list: [
            { name: 'Mar+�a G.', text: 'Los productos llegaron super bien empacados y antes del tiempo estimado. -�Todo 100% original!', country: 'M+�xico', img: 'https://images.unsplash.com/photo-1438761681033-6461ffad8d80?q=80&w=150' },
            { name: 'Carolina R.', text: 'Me encanta la atenci+�n, siempre me ayudan a elegir lo mejor para mi piel. -�Recomendad+�simas!', country: 'Chile', img: 'https://images.unsplash.com/photo-1544005313-94ddf0286df2?q=80&w=150' },
      ...
      comoFunciona: {
        hero: {
          title: 'C+�mo funciona',
          subtitle: 'Hemos simplificado cada paso para que tu experiencia de compra sea segura, pr+�ctica y confiable.',
        ...
        shippingInfo: {
          ...
          items: [
            ...
            { title: 'Tiempo estimado de entrega', text: 'De 7 a 20 d+�as h+�biles, dependiendo de tu pa+�s.' },
            { title: 'Te mantenemos informada', text: 'Recibir+�s tu n+�mero de seguimiento para acompa+�ar cada paso de tu pedido.' }
          ]
        },
        faq: {
          ...
          items: [
            ...
            '-+Cu+�nto tarda en llegar mi pedido?',
        ...
        community: {
          title: '+�nete a nuestra comunidad',
          desc: 'Descubre rutinas, tips, lanzamientos y mucho m+�s en Instagram.',
          buttonText: 'SEGUIR EN INSTAGRAM',
          buttonLink: 'https://www.instagram.com/lacheotnun/',
          images: [
      ...
      contacto: {
        hero: {
          ...
          title: 'Estamos aqu+�\npara ti',
          subtitle: '-+Tienes preguntas, necesitas ayuda con tu pedido o quieres m+�s informaci+�n sobre nuestros productos? Nuestro equipo est+� listo para ayudarte.',
          buttonText: 'RESPUESTA R+�PIDA Y PERSONALIZADA',
          badges: [
        ...
        contactMethods: {
          ...
          whatsapp: { label: 'Chat en vivo', value: 'WhatsApp: +34 600 111 222', time: 'Lunes a Viernes, 9:00 - 18:00', desc: 'La forma m+�s r+�pida de hablar con nuestro equipo.', btn: 'ESCRIBIR AHORA', link: '#contacto-form' },
          ...
          instagram: { label: 'Instagram', value: '@lacheotnun', time: '', desc: 'Env+�anos un mensaje directo en Instagram.', btn: 'IR AL INSTAGRAM', link: 'https://www.instagram.com/lacheotnun/' },
        ...
        form: {
          ...
          securityNotice: 'Tu informaci+�n est+� segura con nosotros y no ser+� compartida.',
          successAlert: '-�Mensaje enviado con +�xito! Nos pondremos en contacto pronto.'
        },
        faq: {
          title: '-+En qu+� podemos ayudarte?',
          subtitle: 'Preguntas frecuentes r+�pidas',
          ...
          quickItems: [
            '-+Cu+�nto tiempo tarda en llegar mi pedido?',
            '-+Qu+� m+�todos de pago aceptan?',
      ...
      ayudaDevoluciones: {
        hero: {
          ...
          steps: [
            ...
            { step: '04', icon: 'ShieldCheck', title: 'Reembolso (5-7 d+�as)', desc: 'Una vez recibido y verificado, procesamos el reembolso en 5-7 d+�as h+�biles a tu m+�todo de pago original.' }
          ],
          summary: [
            ...
            { icon: 'CheckCircle', title: 'Reembolso R+�pido', text: '5-7 d+�as h+�biles tras verificaci+�n' }
          ],
          ...
          contactText: 'Nuestro equipo de atenci+�n al cliente est+� disponible para ayudarte con cualquier duda sobre cambios o devoluciones.',
      ...
      envios: {
        ...
        shipping: {
          ...
          tableSubtitle: 'Realizamos env+�os a todos estos pa+�ses y m+�s.'
        },
        payments: {
          title: 'Pagos seguros',
          subtitle: 'Ofrecemos m+�ltiples opciones de pago para tu comodidad.',
          methods: [
            { name: 'Tarjetas de cr+�dito', desc: 'Aceptamos Visa, Mastercard, American Express y m+�s.' },
            { name: 'PayPal', desc: 'Paga de forma r+�pida y segura con tu cuenta de PayPal.' },
            { name: 'Transferencia bancaria', desc: 'Disponibles para algunos pa+�ses. Cont+�ctanos para m+�s informaci+�n.' }
          ]
        }
      }
    },
    ...
    terminos: {
      ...
      intro: {
        p1: 'Bienvenido a Cheotnun K-Beauty. Al acceder y utilizar este sitio web, aceptas cumplir con los siguientes t+�rminos y condiciones. Si no est+�s de acuerdo con alguno de estos t+�rminos, te recomendamos no utilizar nuestros servicios.',
      ...
      sections: [
        { icon: 'ShoppingBag', title: 'Productos y Precios', content: 'Todos los productos est+�n sujetos a disponibilidad. Nos reservamos el derecho de modificar precios sin previo aviso. Los precios mostrados incluyen impuestos aplicables pero no incluyen gastos de env+�o.' },
        { icon: 'CreditCard', title: 'Pagos y Facturaci+�n', content: 'Aceptamos pagos a trav+�s de Stripe, PayPal y transferencia bancaria. El cargo se realizar+� en el momento de la compra. Emitimos factura electr+�nica para todos los pedidos.' },
        ...
        { icon: 'ShieldCheck', title: 'Propiedad Intelectual', content: 'Todo el contenido de este sitio web, incluyendo im+�genes, textos y logotipos, es propiedad de Cheotnun K-Beauty y est+� protegido por leyes de propiedad intelectual.' },
    ...
    privacidad: {
      hero: {
        ...
        subtitle: 'Tus datos est+�n seguros con nosotros. Conoce c+�mo recopilamos, usamos y protegemos tu informaci+�n personal.'
      },
      intro: {
        ...
        brand: 'Cheotnun K-Beauty',
        p2: 'Al usar nuestra web, aceptas las pr+�cticas descritas en esta pol+�tica. Te recomendamos leerla detenidamente.',
      ...
      security: {
        ...
        p2: 'Aunque usamos las mejores pr+�cticas, ninguna transmisi+�n por Internet es 100% segura. Hacemos todo lo posible para proteger tu informaci+�n.'
      },
      cookies: {
        title: 'Uso de Cookies',
        p1: 'Usamos cookies propias y de terceros para mejorar tu experiencia de navegaci+�n, analizar el tr+�fico y personalizar contenido.',
      ...
      contact: {
        ...
        desc: 'Nuestro Delegado de Protecci+�n de Datos est+� disponible para resolver cualquier consulta.',
        email: 'dpo@cheotnun.com',
        address: 'Calle Gran V+�a 12, Madrid, Espa+�a'
      },
      sections: [
        { icon: 'FileText', title: 'Informaci+�n que Recopilamos', content: 'Recopilamos informaci+�n que nos proporcionas directamente (nombre, email, direcci+�n) e informaci+�n de navegaci+�n (cookies, p+�ginas visitadas).' },
    ...
    translations: {
      pt: {
        home: {
          hero: {
            ...
            subtitle: 'Cosm+�ticos coreanos aut+�nticos selecionados para cada etapa do seu cuidado facial. F+�rmulas bot+�nicas que revelam sua luminosidade natural.',
          ...
          categories: {
            ...
            subtitle: 'Descubra nossa sele+�+�o completa de produtos K-Beauty organizados por categoria para encontrar exatamente o que sua pele precisa.',
            buttonText: 'VER MAIS'
          },
          bestSellers: {
            preTitle: 'MAIS VENDIDOS',
            title: 'Os Favoritos',
            subtitle: 'Os produtos que est+�o conquistando o cora+�+�o das nossas clientes.',
            buttonText: 'VER MAIS'
          },
          experiencias: {
            preTitle: 'EXPERI+�NCIAS',
          ...
          routines: {
            ...
            items: [
              ...
              { icon: 'Sparkles', name: 'Esfolia+�+�o' },
              { icon: 'FlaskConical', name: 'T+�nico' },
              { icon: 'Droplet', name: 'Ess+�ncia' },
              { icon: 'Gem', name: 'S+�rum' },
              { icon: 'Snowflake', name: 'Hidrata+�+�o' }
            ],
            badges: [
        ...
        header: {
          topBar: 'Frete gr+�tis para compras acima de R\$ 297 para todo o Brasil',
          logoText: 'CHEOTNUN',
        ...
        footer: {
          ...
          columns: [
            { title: 'PRODUTOS', links: [
              ...
              { label: 'Lan+�amentos', href: '/tienda' },
              { label: 'Marcas', href: '/marcas' },
              { label: 'Promo+�+�es', href: '/tienda' }
            ]},
            { title: 'AJUDA', links: [
            ...
            { title: 'LEGAL', links: [
              { label: 'T+�rminos e Condi+�+�es', href: '/terminos' },
        ...
        marcas: {
          hero: {
            ...
            title: 'Nossas Marcas',
            subtitle: 'Trabalhamos com as melhores marcas coreanas para levar at+� voc+� o que h+� de mais aut+�ntico e inovador em K-Beauty.'
          },
          features: [
            { icon: 'ShieldCheck', title: '100% Original', text: 'Todos os produtos s+�o adquiridos diretamente de distribuidores oficiais na Coreia.' },
            { icon: 'Truck', title: 'Envio Seguro', text: 'Embalagem especial para garantir que seu produto chegue em perfeitas condi+�+�es.' },
          ...
          whyChooseUs: {
            ...
            items: [
              { icon: 'MapPin', title: 'Conex+�o Direta com a Coreia', text: 'Nossa equipe viaja regularmente +� Coreia para selecionar pessoalmente cada produto.' },
          ...
          testimonials: {
            ...
            list: [
              { text: 'Amei os produtos! Minha pele nunca esteve t+�o radiante. A entrega foi super r+�pida.', img: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=200', name: 'Ana Silva', country: 'Brasil' },
              ...
              { text: 'A Cheotnun mudou minha rotina de skincare. Agora entendo porque o K-Beauty +� t+�o famoso.', img: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=200', name: 'Juliana Oliveira', country: 'Brasil' }
            ],
            buttonLink: '/contacto',
            buttonText: 'COMPARTILHE SUA EXPERI+�NCIA'
          },
          trustBadges: [
        ...
        comoFunciona: {
          hero: { image: '/images/como-funciona-hero.webp', title: 'Como Funciona', subtitle: 'Simples, r+�pido e seguro. Veja como +� f+�cil comprar na Cheotnun.' },
          steps: [
            ...
            { number: '03', icon: 'CreditCard', title: 'Pague', text: 'Escolha seu m+�todo de pagamento preferido (cart+�o, PayPal ou transfer+�ncia).' },
            { number: '04', icon: 'Package', title: 'Receba', text: 'Seu pedido chega na sua casa com toda seguran+�a e rastreamento.' }
          ],
          paymentsInfo: { title: 'M+�todos de Pagamento', subtitle: 'Aceitamos diversas formas de pagamento para sua comodidade.' },
          shippingInfo: {
            title: 'Informa+�+�es de Envio',
            subtitle: 'Envio para toda Am+�rica Latina com seguro e rastreamento inclusos.',
            items: [
              { title: 'Prazo de Entrega', text: '7 a 15 dias +�teis dependendo do destino. Trabalhamos com transportadoras parceiras que atuam em toda a regi+�o.' },
              { title: 'Rastreamento', text: 'Fornecemos c+�digo de rastreamento para todos os pedidos. Voc+� acompanha cada etapa at+� receber.' },
              { title: 'Seguro', text: 'Todos os envios incluem seguro contra extravio ou danos. Sua compra est+� protegida do in+�cio ao fim.' }
            ]
          },
          faq: {
            title: 'Perguntas frequentes',
          ...
          community: {
            ...
            desc: 'Descubra rotinas, dicas, lan+�amentos e muito mais no Instagram.',
          ...
          newsletter: {
            ...
            subtitle: 'Novos lan+�amentos, ofertas exclusivas e conte+�do especial direto no seu e-mail.',
            placeholder: 'Seu melhor e-mail',
            buttonText: 'QUERO RECEBER',
            disclaimer: 'Prometemos n+�o enviar spam. Compartilhamos apenas o melhor do K-Beauty.'
          }
        },
        contacto: {
          hero: { image: '/images/cheotnun-k-beauty-contato-atendimento.webp', title: 'Fale Conosco', subtitle: 'Estamos aqui para ajudar voc+� com d+�vidas, sugest+�es ou qualquer necessidade.', buttonText: 'RESPOSTA R+�PIDA E PERSONALIZADA', badges: [{ icon: 'Clock', text: 'Atendimento em portugu+�s' }, { icon: 'Clock', text: 'Resposta em menos de 24h' }, { icon: 'CheckCircle2', text: 'Sua satisfa+�+�o +� nossa prioridade' }] },
          contactMethods: {
            title: 'Formas de contato',
            whatsapp: { label: 'WhatsApp', value: '+55 (11) 99999-9999', time: 'Seg a Sex, 9h +�s 18h (GMT-3)', desc: 'A forma mais r+�pida de falar com nossa equipe.', btn: 'FALAR AGORA', link: '#contacto-form' },
            ...
            hours: { label: 'Hor+�rio de atendimento', value: 'Exceto feriados', time: '', desc: 'Segunda a sexta 9h +�s 18h (GMT-3)', btn: 'VER HOR+�RIOS', link: '#' },
            address: { label: 'Endere+�o', value: 'S+�o Paulo, SP, Brasil', time: '', desc: 'Escrit+�rio administrativo', btn: 'VER NO MAPA', link: '#' }
          },
          form: {
            ...
            subjectOptions: ['Selecione um assunto', 'D+�vidas sobre produtos', 'Status do meu pedido', 'Devolu+�+�es', 'Outros'],
            messageLabel: 'Sua mensagem',
            submitText: 'ENVIAR MENSAGEM',
            securityNotice: 'Suas informa+�+�es est+�o seguras conosco e n+�o ser+�o compartilhadas.',
            successAlert: 'Mensagem enviada com sucesso! Entraremos em contato em breve.'
          },
          faq: {
            title: 'Em que podemos ajudar?',
            subtitle: 'Perguntas frequentes r+�pidas',
            buttonText: 'VER TODAS AS PERGUNTAS FREQUENTES',
            topics: [
              { icon: 'Info', title: 'Informa+�+�es sobre produtos', desc: 'D+�vidas sobre ingredientes, benef+�cios e recomenda+�+�es.' },
              { icon: 'PackageSearch', title: 'Pedidos e envios', desc: 'Consulte o status do seu pedido, prazos de entrega.' },
              { icon: 'CreditCard', title: 'Pagamentos e faturamento', desc: 'Informa+�+�es sobre m+�todos de pagamento, notas fiscais e reembolsos.' },
              { icon: 'RefreshCw', title: 'Devolu+�+�es e trocas', desc: 'D+�vidas sobre trocas, devolu+�+�es e garantias.' },
              { icon: 'Handshake', title: 'Colabora+�+�es e imprensa', desc: 'Propostas de colabora+�+�o, eventos e imprensa.' }
            ],
            quickItems: [
              'Quanto tempo leva para meu pedido chegar?',
          ...
          community: {
            title: 'Junte-se +� nossa comunidade',
            desc: 'Siga-nos nas redes sociais e seja a primeira a descobrir lan+�amentos, promo+�+�es e dicas de beleza.',
            buttonText: 'SEGUIR NO INSTAGRAM',
            buttonLink: 'https://www.instagram.com/lacheotnun/',
            images: [
              'https://images.unsplash.com/photo-1615397323281-a6cecd55dbf7?q=80&w=300',
        ...
        envios: {
          hero: { image: '/images/envios-hero.webp', title: 'Env+�os e Pagamentos', subtitle: 'Toda a informa+�+�o sobre prazos, custos e m+�todos de pagamento.', text: 'Na Cheotnun queremos que sua experi+�ncia de compra seja tranquila e segura.' },
          features: [
          ...
          shipping: {
            ...
            text: 'Trabalhamos com parceiros log+�sticos internacionais para garantir que seu pedido chegue r+�pido e com seguran+�a.',
            tableTitle: 'Prazos e Custos de Envio',
            tableSubtitle: 'Valores e prazos estimados por regi+�o.'
          },
          payments: {
            title: 'M+�todos de Pagamento',
            subtitle: 'Aceitamos diversas formas de pagamento para sua comodidade.',
            methods: [
              { name: 'Cart+�o de Cr+�dito', desc: 'Visa, Mastercard, American Express e Diners Club. Parcelamento em at+� 6x.' },
              { name: 'PayPal', desc: 'Pague com sua conta PayPal de forma r+�pida e segura.' },
              { name: 'Transfer+�ncia Banc+�ria', desc: 'Transfer+�ncia direta para nossa conta. Consulte os dados ap+�s finalizar a compra.' },
              { name: 'Pix', desc: 'Pagamento instant+�neo para clientes no Brasil.' }
            ]
          }
        },
        ayudaDevoluciones: {
          hero: {
            badge: 'Pol+�tica de Devolu+�+�o',
            title: 'Devoluciones e Reembolsos',
            subtitle: 'Na Cheotnun sua satisfa+�+�o +� nossa prioridade. Se por algum motivo voc+� n+�o ficar satisfeita, estamos aqui para ajudar.',
            steps: [
              { icon: 'Mail', number: '1', title: 'Solicite', desc: 'Envie um e-mail para devoluciones@cheotnun.com com seu n+�mero de pedido e motivo da devolu+�+�o.' },
              { icon: 'ClipboardCheck', number: '2', title: 'Aprovamos', desc: 'Nossa equipe analisar+� sua solicita+�+�o em at+� 48 horas +�teis.' },
              { icon: 'Package', number: '3', title: 'Envie', desc: 'Ap+�s aprova+�+�o, enviaremos as instru+�+�es para devolu+�+�o do produto.' },
              { icon: 'RefreshCw', number: '4', title: 'Reembolsamos', desc: 'Assim que recebermos e verificarmos o produto, processaremos o reembolso.' }
            ],
            sectionTitle: 'Processo de Devolu+�+�o',
            summary: [
              { title: 'Prazo', text: 'At+� 14 dias ap+�s o recebimento do pedido.' },
              { title: 'Condi+�+�o', text: 'Produto sem uso, na embalagem original e com todos os lacres.' },
              { title: 'Custo', text: 'Gratuito para produtos com defeito. O cliente arca com o frete nos demais casos.' }
            ],
            conditionsTitle: 'Condi+�+�es para Devolu+�+�o',
            conditions: [
              'O produto deve estar sem uso e na embalagem original.',
              'Todos os lacres e selos de garantia devem estar intactos.',
              'A solicita+�+�o deve ser feita em at+� 14 dias corridos ap+�s o recebimento.',
              'Produtos em promo+�+�o ou em kit podem ter condi+�+�es especiais de devolu+�+�o.',
              'O reembolso ser+� processado no mesmo m+�todo de pagamento utilizado na compra.'
            ],
            notAcceptedTitle: 'N+�o Aceitamos Devolu+�+�o de:',
            notAccepted: [
              'Produtos com sinais de uso ou viola+�+�o do lacre de seguran+�a.',
              'Produtos em promo+�+�o ou liquida+�+�o com aviso de n+�o aceita+�+�o de devolu+�+�o.',
              'Amostras gr+�tis ou brindes promocionais.',
              'Pedidos com mais de 30 dias ap+�s o recebimento.',
              'Produtos que foram danificados por mau uso ou armazenamento inadequado.'
            ],
            contactTitle: 'Contato para Devolu+�+�es',
            contactText: 'Tem alguma d+�vida sobre o processo de devolu+�+�o? Estamos aqui para ajudar.',
        ...
        rutinasPage: {
          ...
          stepsSection: { title: 'Os Passos do K-Beauty', subtitle: 'A rotina coreana de skincare pode ter de 5 a 12 passos. Aqui est+�o os essenciais.', footerText: 'ԣ� Cada pele +� +�nica. Adapte os passos conforme sua necessidade.' },
          steps: [
            { icon: 'Droplets', title: 'Double Cleansing', desc: 'O primeiro passo +� a limpeza dupla: primeiro um +�leo removedor de maquiagem, depois um cleanser +� base de +�gua.' },
            { icon: 'Sparkles', title: 'Esfolia+�+�o', desc: 'Remove c+�lulas mortas e renova a pele. Recomendamos 1-2 vezes por semana.' },
            ...
            { icon: 'Gem', title: 'S+�rum', desc: 'Concentrado de ativos para tratar necessidades espec+�ficas: vitamina C, +�cido hialur+�nico, retinol.' },
            { icon: 'Snowflake', title: 'Hidrata+�+�o', desc: 'Creme hidratante que sela todos os passos anteriores e mant+�m a pele macia.' }
          ],
          ingredientsSection: { title: 'Ingredientes Coreanos', subtitle: 'Conhe+�a os ingredientes estrela da cosm+�tica coreana.' },
          ingredients: [
            ...
            { img: 'https://images.unsplash.com/photo-1617897903246-719242758050?q=80&w=200', name: 'Centella Asiatica', desc: 'Acalma, cicatriza e reduz inflama+�+�es. Perfeita para peles sens+�veis.' },
            { img: 'https://images.unsplash.com/photo-1611930022073-b7a4ba5fcccd?q=80&w=200', name: '+�cido Hialur+�nico', desc: 'Hidrata+�+�o profunda que ret+�m a umidade na pele.' },
            ...
            { img: 'https://images.unsplash.com/photo-1608248543803-ba4f8c70ae0b?q=80&w=200', name: 'Pr+�polis', desc: 'Antibacteriano natural, hidrata e d+� luminosidade.' },
            ...
            { img: 'https://images.unsplash.com/photo-1596462502278-27bfdc403348?q=80&w=200', name: 'Ceramidas', desc: 'Restauram a barreira de prote+�+�o da pele, evitando a perda de umidade.' },
            { img: 'https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?q=80&w=200', name: 'Retinol', desc: 'Antienvelhecimento potente que estimula col+�geno e renova as c+�lulas.' }
          ],
          routineSection: { title: 'Ordem da Rotina', boxTitle: 'Sua rotina pode ser +�nica.', boxDesc: 'Comece com o b+�sico e adicione passos conforme sua pele se acostuma. O segredo +� a consist+�ncia nos cuidados di+�rios.' },
          routineSteps: [
            { num: '1', title: 'Limpeza', icon: 'Droplets', sub: '+�leo + Water Cleanser' },
            { num: '2', title: 'Esfolia+�+�o', icon: 'Sparkles', sub: '1-2x/semana' },
            ...
            { num: '5', title: 'Hidrata+�+�o', icon: 'Snowflake', sub: 'Creme + +�leo' },
            { num: '6', title: 'Prote+�+�o', icon: 'Sun', sub: 'Protetor Solar (manh+�)' }
          ],
          tipsSection: { title: 'Dicas Essenciais' },
          tips: [
            { title: 'Conhe+�a seu Tipo de Pele', desc: 'Antes de come+�ar qualquer rotina, identifique se sua pele +� oleosa, seca, mista ou sens+�vel.', img: 'https://images.unsplash.com/photo-1556228578-0d85b1a4d571?q=80&w=400', icon: 'Search' },
            { title: 'Introduza um Passo de Cada Vez', desc: 'Comece com limpeza, hidrata+�+�o e protetor solar. Depois adicione s+�rum, esfolia+�+�o e tratamentos.', img: 'https://images.unsplash.com/photo-1556228578-0d85b1a4d571?q=80&w=400', icon: 'ArrowRight' },
            { title: 'Seja Consistente', desc: 'Resultados reais v+�m com o uso di+�rio. D+� +� sua pele tempo para se adaptar aos novos produtos.', img: 'https://images.unsplash.com/photo-1556228578-0d85b1a4d571?q=80&w=400', icon: 'Clock' },
            { title: 'Protetor Solar +� Inegoci+�vel', desc: 'Use todos os dias, mesmo em casa. A prote+�+�o solar previne envelhecimento precoce e manchas.', img: 'https://images.unsplash.com/photo-1556228578-0d85b1a4d571?q=80&w=400', icon: 'Sun' }
          ],
          ...
          makeup: [
            ...
            { name: 'M+�scara de C+�lios', img: 'https://images.unsplash.com/photo-1596462502278-27bfdc403348?q=80&w=200' },
          ...
          faq: [
            { q: 'Quantos passos uma rotina coreana tem?', a: 'A rotina tradicional coreana tem entre 5 e 12 passos. Recomendamos come+�ar com o essencial e adicionar conforme sua pele se adapta.' },
            ...
            { q: 'Qual a diferen+�a entre ess+�ncia e s+�rum?', a: 'A ess+�ncia +� mais l+�quida e hidrata superficialmente. O s+�rum +� mais concentrado e trata problemas espec+�ficos.' },
            { q: 'Com que idade devo come+�ar a usar antienvelhecimento?', a: 'A preven+�+�o pode come+�ar aos 20-25 anos com antioxidantes como vitamina C. Retinol e ativos mais potentes geralmente a partir dos 30.' }
          ],
          newsletter: { title: 'Receba dicas exclusivas', subtitle: 'e fique por dentro das novidades do universo K-Beauty.', buttonText: 'QUERO RECEBER', disclaimer: 'Prometemos n+�o enviar spam. Voc+� pode cancelar a qualquer momento.', image: 'https://images.unsplash.com/photo-1616394584738-fc6e612e71b9?q=80&w=400' }
        },
        experienciasPage: {
          hero: { title: 'Experi+�ncias Cheotnun', subtitle: 'Muito mais que produtos, uma conex+�o com a cultura coreana.', buttonText: 'Conecte-se com a cultura coreana', image: '/images/cheotnun-k-beauty-experiencias-viagens.webp' },
          ...
          experiencesList: [
            ...
            { icon: 'Heart', title: 'Retiros de Bem-Estar', desc: 'Programas imersivos que combinam skincare, bem-estar e conex+�o com a natureza.', img: 'https://images.unsplash.com/photo-1493976040374-85c8e12f0c0e?q=80&w=400' }
          ],
          maeum: {
            badge: 'Em parceria com',
            title: 'MAEUM GLOBAL',
            subtitle: 'Viagens que transformam.',
            desc: 'Maeum Global leva voc+� +� Coreia para viver experi+�ncias +�nicas de beleza, cultura e bem-estar.',
            points: [
              'Roteiros personalizados de K-Beauty',
              'Acompanhamento de especialistas locais',
              'Visitas a f+�bricas e boutiques exclusivas',
              'Aulas de maquiagem e skincare coreano'
            ],
            buttonLink: 'https://www.maeumglobal.com.br',
            buttonText: 'SAIBA MAIS',
            cards: [
              { title: 'Imers+�o Cultural', desc: 'Conhe+�a a Coreia al+�m do skincare: hist+�ria, gastronomia e muito mais.', img: 'https://images.unsplash.com/photo-1538481199705-c710c4e965fc?q=80&w=400', icon: 'Compass' },
              ...
              { title: 'Aprendizado', desc: 'Workshops pr+�ticos com maquiadores e dermatologistas coreanos.', img: 'https://images.unsplash.com/photo-1558980395-be8a5fcb4251?q=80&w=400', icon: 'BookOpen' }
            ]
          },
          testimonials: {
            title: 'Depoimentos',
            buttonText: 'COMPARTILHE SUA EXPERI+�NCIA',
            list: [
              { quote: 'Uma experi+�ncia que mudou minha forma de ver a beleza. Coreia +� m+�gico.', name: 'Camila R.', country: 'Brasil', img: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?q=80&w=200' },
              ...
              { quote: 'Viajar com Maeum Global e Cheotnun foi a melhor decis+�o. Repetirei sem d+�vidas.', name: 'Valentina L.', country: 'Brasil', img: 'https://images.unsplash.com/photo-1534528741775-53994a69daeb?q=80&w=200' }
            ]
          },
          newsletter: {
            title: 'Seja a primeira a saber',
            ...
            disclaimer: 'Prometemos n+�o enviar spam. Voc+� pode cancelar quando quiser.'
          }
        },
        terminos: {
          hero: { badge: 'Marco Legal', title: 'Termos e Condi+�+�es', subtitle: 'Conhe+�a as regras que regem o uso da nossa plataforma e a rela+�+�o com nossos clientes.' },
          intro: { p1: 'Bem-vindo +� Cheotnun K-Beauty. Ao acessar e utilizar este site, voc+� aceita cumprir os seguintes termos e condi+�+�es. Se n+�o concordar com algum destes termos, recomendamos n+�o utilizar nossos servi+�os.', brand: 'Cheotnun K-Beauty', p2: 'Estes termos estabelecem os direitos e obriga+�+�es entre Cheotnun K-Beauty e os usu+�rios de nossa loja online especializada em cosm+�ticos coreanos.' },
          company: { name: 'Cheotnun K-Beauty', nif: 'B-12345678', address: 'S+�o Paulo, SP, Brasil', email: 'ola@cheotnun.com', phone: '+55 (11) 99999-9999' },
          additional: { ageTitle: 'Idade M+�nima', ageDesc: 'Voc+� deve ser maior de 18 anos ou ter autoriza+�+�o legal para realizar compras em nossa loja. Ao se registrar, confirma que cumpre este requisito.', accountTitle: 'Contas de Usu+�rio', accountDesc: 'Voc+� +� respons+�vel por manter a confidencialidade de suas credenciais de acesso. Notifique-nos imediatamente sobre qualquer uso n+�o autorizado de sua conta.' },
          ...
          sections: [
            { icon: 'ShoppingBag', title: 'Produtos e Pre+�os', content: 'Todos os produtos est+�o sujeitos +� disponibilidade. Reservamo-nos o direito de modificar pre+�os sem aviso pr+�vio. Os pre+�os exibidos incluem impostos aplic+�veis mas n+�o incluem frete.' },
            { icon: 'CreditCard', title: 'Pagamentos e Faturamento', content: 'Aceitamos pagamentos via cart+�o de cr+�dito, PayPal e Pix. O pagamento ser+� processado no momento da compra. Emitimos nota fiscal para todos os pedidos.' },
            { icon: 'Truck', title: 'Envios e Entregas', content: 'Realizamos envios para todo o Brasil e Am+�rica Latina. Os prazos de entrega variam conforme o destino. N+�o nos responsabilizamos por atrasos alfandeg+�rios ap+�s o pacote sair da Coreia do Sul.' },
            { icon: 'RotateCcw', title: 'Devolu+�+�es e Reembolsos', content: 'Aceitamos devolu+�+�es dentro de 14 dias ap+�s o recebimento. O produto deve estar sem uso e na embalagem original. O frete de devolu+�+�o +� por conta do cliente, exceto para produtos com defeito.' },
            { icon: 'ShieldCheck', title: 'Propriedade Intelectual', content: 'Todo o conte+�do deste site, incluindo imagens, textos e logotipos, +� propriedade da Cheotnun K-Beauty e est+� protegido por leis de propriedade intelectual.' },
            { icon: 'Scale', title: 'Limita+�+�o de Responsabilidade', content: 'A Cheotnun K-Beauty n+�o se responsabiliza por danos indiretos decorrentes do uso de nossos produtos. Cada produto inclui instru+�+�es de uso que devem ser seguidas cuidadosamente.' }
          ]
        },
        privacidad: {
          hero: { badge: 'Transpar+�ncia e Seguran+�a', title: 'Pol+�tica de Privacidade', subtitle: 'Seus dados est+�o seguros conosco. Saiba como coletamos, usamos e protegemos suas informa+�+�es pessoais.' },
          intro: { p1: 'Na Cheotnun K-Beauty levamos sua privacidade muito a s+�rio. Esta pol+�tica descreve como coletamos, utilizamos e protegemos seus dados pessoais ao utilizar nossa loja online.', brand: 'Cheotnun K-Beauty', p2: 'Ao usar nosso site, voc+� aceita as pr+�ticas descritas nesta pol+�tica. Recomendamos a leitura atenta.', p3: 'Nosso compromisso +� garantir a confidencialidade e seguran+�a dos seus dados pessoais de acordo com a legisla+�+�o aplic+�vel.' },
          security: { title: 'Seguran+�a de Dados', p1: 'Implementamos medidas de seguran+�a t+�cnicas e organizacionais para proteger seus dados pessoais contra acessos n+�o autorizados, perda ou destrui+�+�o.', p2: 'Embora usemos as melhores pr+�ticas, nenhuma transmiss+�o pela Internet +� 100% segura. Fazemos todo o poss+�vel para proteger suas informa+�+�es.' },
          cookies: { title: 'Uso de Cookies', p1: 'Utilizamos cookies pr+�prios e de terceiros para melhorar sua experi+�ncia de navega+�+�o, analisar o tr+�fego e personalizar conte+�do.', p2: 'Voc+� pode configurar seu navegador para recusar cookies, embora isso possa afetar a funcionalidade de algumas partes do site.' },
          contact: { title: 'D+�vidas sobre Privacidade?', desc: 'Nosso Encarregado de Prote+�+�o de Dados est+� dispon+�vel para responder qualquer d+�vida.', email: 'dpo@cheotnun.com', address: 'S+�o Paulo, SP, Brasil' },
          sections: [
            { icon: 'FileText', title: 'Informa+�+�es que Coletamos', content: 'Coletamos informa+�+�es que voc+� nos fornece diretamente (nome, e-mail, endere+�o) e informa+�+�es de navega+�+�o (cookies, p+�ginas visitadas).' },
            { icon: 'ShieldCheck', title: 'Uso das suas Informa+�+�es', content: 'Utilizamos seus dados para processar pedidos, melhorar nossos servi+�os, enviar comunica+�+�es comerciais (com seu consentimento) e cumprir obriga+�+�es legais.' },
            { icon: 'Share2', title: 'Compartilhamento de Informa+�+�es', content: 'N+�o vendemos seus dados pessoais. Compartilhamos informa+�+�es apenas com provedores de servi+�os essenciais (processamento de pagamentos, log+�stica de envios) sob estritos acordos de confidencialidade.' },
            { icon: 'Clock', title: 'Reten+�+�o de Dados', content: 'Mantemos seus dados enquanto voc+� tiver uma conta ativa ou pelo tempo necess+�rio para cumprir obriga+�+�es legais e fiscais.' },
            ...
            { icon: 'Globe', title: 'Transfer+�ncias Internacionais', content: 'Por ser uma loja com opera+�+�es internacionais, seus dados podem ser transferidos e armazenados em servidores fora do seu pa+�s de resid+�ncia.' }
          ]
        },
        blog: {
          pageTitle: 'Blog Cheotnun K-Beauty',
      ...
      en: {
        ...
        rutinasPage: {
          ...
          stepsSection: { title: 'Steps of K-Beauty', subtitle: 'The Korean skincare routine can have 5 to 12 steps. Here are the essentials.', footerText: 'ԣ� Every skin is unique. Adapt the steps to your needs.' },
          steps: [
  ...
  blog_posts: [
    { id: '1', title: '5 Secretos del Skincare Coreano para una Piel Radiante', slug: '5-secretos-skincare-coreano', subtitle: 'Descubre los principios fundamentales de la rutina coreana que transformar+�n tu piel.', content: '<p>El skincare coreano no es solo una moda, es una filosof+�a de cuidado. Aqu+� te revelamos los 5 secretos mejor guardados que toda rutina K-Beauty debe incluir para lograr una piel luminosa y saludable.</p><h3>1. Doble Limpieza</h3><p>El primer paso y el m+�s importante. Consiste en usar primero un limpiador a base de aceite para eliminar maquillaje y protector solar, seguido de un limpiador a base de agua para limpiar profundamente los poros.</p><h3>2. Exfoliaci+�n Suave</h3><p>Olv+�date de los exfoliantes agresivos. En Corea se prefiere la exfoliaci+�n qu+�mica suave con ingredientes como +�cido l+�ctico o PHA que renuevan la piel sin da+�arla.</p><h3>3. Esencias y S+�rums</h3><p>Las esencias son el coraz+�n de la rutina coreana. Aplicadas despu+�s del t+�nico, preparan la piel para absorber mejor los s+�rums y tratamientos posteriores.</p><h3>4. Hidrataci+�n en Capas</h3><p>La clave est+� en aplicar m+�ltiples capas ligeras de hidrataci+�n en lugar de una sola crema pesada. Esto permite que cada producto penetre mejor.</p><h3>5. Protecci+�n Solar Diaria</h3><p>El paso m+�s importante. Un buen protector solar coreano no solo protege, sino que tambi+�n cuida y nutre la piel mientras la defiende de los rayos UV.</p>', image: 'https://images.unsplash.com/photo-1556228720-195a672e8a03?q=80&w=1200', author: 'Dr. Park', seo_title: '5 Secretos del Skincare Coreano | K-Beauty Tips', seo_description: 'Descubre los 5 secretos fundamentales del skincare coreano para transformar tu rutina de belleza. Aprende sobre doble limpieza, s+�rums y m+�s.', created_at: '2026-07-08', status: 'published' },
    { id: '2', title: 'C+�mo Aplicar el Dokdo Cleanser de Round Lab', slug: 'como-aplicar-dokdo-cleanser-round-lab', subtitle: 'Gu+�a paso a paso para usar correctamente el limpiador facial m+�s popular de Round Lab.', content: '<p>El Dokdo Cleanser de Round Lab se ha convertido en un producto imprescindible en muchas rutinas coreanas. Te ense+�amos c+�mo aplicarlo correctamente para obtener los mejores resultados.</p><h3>-+Por qu+� es tan especial?</h3><p>Formulado con agua del mar profundo de la isla Dokdo, este limpiador elimina impurezas mientras mantiene la hidrataci+�n natural de la piel gracias a sus ingredientes minerales.</p><h3>Paso a Paso</h3><p><strong>Paso 1:</strong> Humedece tu rostro con agua tibia para abrir los poros.</p><p><strong>Paso 2:</strong> Aplica una peque+�a cantidad de producto en la palma de tu mano.</p><p><strong>Paso 3:</strong> Masajea suavemente en c+�rculos durante 30-60 segundos.</p><p><strong>Paso 4:</strong> Enjuaga con agua tibia y seca suavemente con una toalla limpia.</p><h3>Consejos Extra</h3><p>Util+�zalo tanto en tu rutina de ma+�ana como de noche. Por la ma+�ana eliminar+� el exceso de grasa nocturna, y por la noche retirar+� las impurezas acumuladas durante el d+�a.</p>', image: 'https://images.unsplash.com/photo-1608248597279-f99d160bfcbc?q=80&w=1200', author: 'Kim Min-seo', seo_title: 'C+�mo Aplicar Dokdo Cleanser | Gu+�a Round Lab', seo_description: 'Aprende a aplicar correctamente el Dokdo Cleanser de Round Lab. Gu+�a paso a paso con consejos profesionales para maximizar sus beneficios.', created_at: '2026-07-09', status: 'published' }
  ],
