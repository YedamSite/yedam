...
export default function ContactoPage() {
  ...
  const methods = [
    ...
    { icon: 'Instagram', title: c?.contactMethods?.instagram?.label || 'Instagram', desc: c?.contactMethods?.instagram?.desc || 'Envíanos un mensaje directo en Instagram.', btn: c?.contactMethods?.instagram?.btn || 'IR AL INSTAGRAM', link: c?.contactMethods?.instagram?.link || 'https://www.instagram.com/lacheotnun?igsh=MXUzYTZtNXB6MWRzbA==&igsi=MXUzYTZtNXB6MWRzbA==', footer: c?.contactMethods?.instagram?.value || '@lacheotnun' },
        ...
        <section className="w-full max-w-[1400px] mx-auto px-6 lg:px-12 mb-16">
           <div className="bg-[#EAE4DC] rounded-3xl p-8 lg:p-10 flex flex-col xl:flex-row gap-8 items-center xl:items-center shadow-lg">
              <div className="flex-1 max-w-sm text-center xl:text-left text-[#1c2838]">
                 ...
                 <a href={c?.community?.buttonLink || 'https://www.instagram.com/lacheotnun?igsh=MXUzYTZtNXB6MWRzbA==&igsi=MXUzYTZtNXB6MWRzbA=='} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 border border-[#1c2838] hover:bg-[#1c2838] hover:text-[#FDF9F4] text-[#1c2838] font-bold text-[9px] tracking-widest px-6 py-3 rounded-md uppercase transition-all">
              ...
              {communityImages.length > 0 && (
                <div className="flex-1 grid grid-cols-2 md:grid-cols-4 gap-4 w-full">
                  {communityImages.map((img: string, idx: number) => (
                     <a key={idx} href={c?.community?.buttonLink || 'https://www.instagram.com/lacheotnun?igsh=MXUzYTZtNXB6MWRzbA==&igsi=MXUzYTZtNXB6MWRzbA=='} target="_blank" rel="noreferrer" className="relative h-32 md:h-40 rounded-xl overflow-hidden group">
