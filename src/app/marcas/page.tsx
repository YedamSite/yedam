    ...
    <div className="min-h-screen bg-[#07101E] flex flex-col font-body selection:bg-[#C9C9C9]/30 text-white">
      ...
      <main className="flex-1 w-full overflow-hidden">
        ...
        <section className="w-full px-4 lg:px-12 pb-24 max-w-[1400px] mx-auto flex flex-col items-center">
          ...
          <a href={c?.testimonials?.buttonLink || 'https://www.instagram.com/lacheotnun?igsh=MXUzYTZtNXB6MWRzbA==&igsi=MXUzYTZtNXB6MWRzbA=='} target="_blank" rel="noopener noreferrer" className="mt-12 px-8 py-3 rounded-full border border-white/20 text-xs font-bold tracking-widest uppercase hover:bg-white/5 transition-colors">
