      ...
      <main className="flex-1">
        ...
        <section className="relative w-full min-h-[30vh] flex items-center justify-center overflow-hidden border-b border-white/5">
          ...
          <div className="relative z-10 text-center px-4 max-w-3xl mx-auto py-16">
            <span className="text-[10px] font-bold text-accent tracking-[0.25em] uppercase">Marco Legal</span>
            <h1 className="font-heading text-4xl md:text-5xl font-light text-white mt-4 mb-4 uppercase">Términos y Condiciones</h1>
            <p className="text-sm text-foreground/60 max-w-xl mx-auto leading-relaxed">
              Conoce las reglas que rigen el uso de nuestra plataforma y servicios.
            </p>
          </div>
        </section>
        ...
        <section className="max-w-4xl mx-auto px-4 md:px-8 py-16">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-10">
            <div className="bg-secondary/30 border border-white/5 rounded-3xl p-6">
              <h3 className="font-heading text-base font-bold text-white uppercase mb-4">Edad Mínima</h3>
              <p className="text-sm text-foreground/70 leading-relaxed">
                Debes ser mayor de 18 años para realizar compras en esta web. Al usar nuestros servicios, declaras tener la edad legal requerida.
              </p>
            </div>
            <div className="bg-secondary/30 border border-white/5 rounded-3xl p-6">
              <h3 className="font-heading text-base font-bold text-white uppercase mb-4">Cuentas de Usuario</h3>
              <p className="text-sm text-foreground/70 leading-relaxed">
          ...
          <div className="bg-card border border-white/5 rounded-3xl p-8 text-center">
            <h3 className="font-heading text-xl font-light text-white uppercase mb-3">Consultas Legales</h3>
