        ...
        <section className="w-full max-w-[1400px] mx-auto px-6 lg:px-12 mb-16">
           <div className="flex flex-col xl:flex-row gap-8 items-center xl:items-start">
              <div className="flex-1 max-w-sm mt-4 text-center xl:text-left">
                 ...
                 <a href={c?.community?.buttonLink || 'https://www.instagram.com/lacheotnun?igsh=MXUzYTZtNXB6MWRzbA==&igsi=MXUzYTZtNXB6MWRzbA=='} target="_blank" rel="noreferrer" className="inline-flex items-center gap-2 border border-white/20 hover:bg-white/5 text-white font-bold text-[9px] tracking-widest px-6 py-3 rounded-sm uppercase transition-all">
              ...
              <div className="flex-1 grid grid-cols-2 md:grid-cols-4 gap-4">
                 {(c?.community?.images || [
                   ...
                   'https://images.unsplash.com/photo-1522337360788-8b13dee7a37e?q=80&w=300'
                    ...
                    <a key={idx} href={c?.community?.buttonLink || 'https://www.instagram.com/lacheotnun?igsh=MXUzYTZtNXB6MWRzbA==&igsi=MXUzYTZtNXB6MWRzbA=='} target="_blank" rel="noreferrer" className="relative h-40 md:h-48 rounded-xl overflow-hidden group">
